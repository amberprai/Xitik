            ...
            <ul class="list-group shadow">
                ...
                <li class="list-group-item">
                    ...
                    <div class="media align-items-lg-center flex-column flex-lg-row p-3">
                        ...
                        </div><img src={led} alt="Generic placeholder image" width="250" class="ml-lg-5 order-1 order-lg-2"/>
                    </div> 
                </li> 
                <li class="list-group-item">
                ...
                <li class="list-group-item">
                    ...
                    <div class="media align-items-lg-center flex-column flex-lg-row p-3">
                        ...
                        </div><img src={pic1} alt="Generic placeholder image" width="250" class="ml-lg-5 order-1 order-lg-2"/>
                    </div> 
                </li> 
                ...
                <li class="list-group-item">
                    <div class="media align-items-lg-center flex-column flex-lg-row p-3">
                        ...
                        <img src={pic2} alt="Generic placeholder image" width="250" class="ml-lg-5 order-1 order-lg-2"/>
                    </div> 
                </li> 
                ...
                <li class="list-group-item">
                    ...
                    <div class="media align-items-lg-center flex-column flex-lg-row p-3">
                        ...
                        </div><img src={pic3} alt="Generic placeholder image" width="250" class="ml-lg-5 order-1 order-lg-2"/>
                    </div> 
                </li> 
                <li class="list-group-item">
                    ...
                    <div class="media align-items-lg-center flex-column flex-lg-row p-3">
                        ...
                        </div><img src={pic7} alt="Generic placeholder image" width="250" class="ml-lg-5 order-1 order-lg-2"/>
                    </div> 
                </li> 
                <li class="list-group-item">
                    ...
                    <div class="media align-items-lg-center flex-column flex-lg-row p-3">
                        ...
                        </div><img src={pic8} alt="Generic placeholder image" width="250" class="ml-lg-5 order-1 order-lg-2"/>
                    </div> 
                </li> 
                <li class="list-group-item">
                    ...
                    <div class="media align-items-lg-center flex-column flex-lg-row p-3">
                        ...
                        </div><img src={pic9} alt="Generic placeholder image" width="250" class="ml-lg-5 order-1 order-lg-2"/>
                    </div> 
                </li> 
                <li class="list-group-item">
                    ...
                    <div class="media align-items-lg-center flex-column flex-lg-row p-3">
                        ...
                        </div><img src={pic10} alt="Generic placeholder image" width="250" class="ml-lg-5 order-1 order-lg-2"/>
                    </div> 
                </li> 
                <li class="list-group-item">
                    ...
                    <div class="media align-items-lg-center flex-column flex-lg-row p-3">
                        ...
                        </div><img src={pic11} alt="Generic placeholder image" width="250" class="ml-lg-5 order-1 order-lg-2"/>
                    </div> 
                </li> 
            </ul> 
        </div>
