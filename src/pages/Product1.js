...
import spec from "../img/Pro1Spec.PNG"
...
const Product1 = () =>{
    return(
        ...
        className="mb-2 mt-5"
         >
        <CardHeader style={{color:"white",backgroundColor: "#2B2B52"}} > <h1 className=" text-center  ml-2"><b style={{color:"white"}}> LED BULB </b> </h1></CardHeader>
