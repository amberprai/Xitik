...
const Product3 = () =>{
    return(
        ...
        className="mb-2 mt-5"
         >
        <CardHeader style={{color:"white",backgroundColor: "#2B2B52"}} > <h1 className=" text-center  ml-2"><b style={{color:"white"}}> TOUCH WIFI ON/OFF + WI-FI FAN + DIMMER </b> </h1></CardHeader>
        ...
        <div className="col-lg-15 mx-auto">
         ...
         <li className="list-group-item">
                    <div className="media align-items-lg-center flex-column flex-lg-row p-3">
                        ...
                        </div><img src={pic1} alt="Generic placeholder image" width="50%" className="ml-lg-5 order-1 order-lg-2 mt-2 ml-5"/>
                    </div> 
                </li> 
        </ul>
    </div>
